...
export const FEATURE_METADATA: FeatureInfo[] = [
  ...
  {
    id: "vibe-code",
    title: "Vibe Automator",
    tooltip: "AI board builder with live automations - describe what you need and get a board with automations wired up",
    description: "AI-powered board builder that creates fully configured boards with live automations. Describe a workflow in plain English or pick a template - each one comes with real automation rules (deadline alerts, AI analysis, approval gates, status escalation) ready to fire.",
    category: "dashboard",
    route: "/vibe-code",
    icon: Zap,
    howToSteps: [
      "Click 'Vibe Automator' in the sidebar",
      "Type a description of what you need (e.g., 'discovery tracker with deadline alerts and AI document categorization')",
      "Or browse the pre-built templates - each shows what automations are included",
      "Click to generate and the AI creates your board with automations wired up",
      "Your new board appears with automations active - check the Automations panel to see them",
    ],
    tags: ["ai", "builder", "template", "board", "generate", "automation"],
  },
  {
    id: "client-dashboard",
  ...
  },
  {
    ...
    description: "Comprehensive AI legal workspace with three modes: Verbo (conversational AI with matter context), Library (saved templates), and Draft (generated documents). Features 14 workflow cards including contract analysis, deposition analysis, and jurisdiction comparison.",
    category: "legal-practice",
    route: "/legal-ai",
    icon: Wand2,
    howToSteps: [
  ...
  },
  {
    id: "verbo",
    title: "Verbo",
    tooltip: "Verbo - your AI legal assistant for research, document analysis, and case strategy",
    description: "Multi-model AI assistant (Claude, GPT, Gemini, Synergy Private Server) trained for legal work. Supports matter-specific context injection, document analysis, legal research, case strategy, and automation guidance.",
    category: "ai-investigation",
    route: "/ai-chat",
    icon: Bot,
    howToSteps: [
      "Click Verbo in the sidebar or the Verbo button in the header",
    ...
    tags: ["chatbot", "ai", "legal research", "analysis", "verbo"],
  },
  {
    id: "evidence-vault",
...
export const QUICK_START_STEPS = [
  ...
  { step: 6, title: "Ask Verbo", description: "Use Verbo for legal research, document analysis, or case strategy." },
